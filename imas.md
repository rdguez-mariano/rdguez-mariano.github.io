...
#### Finding near optimal coverings (C++ code)
 ...
 This code doesn't have any documentation available yet but there exist a pseudo-code that has been published in IPOL [(See its web page)](/hyperdescriptors). Executing the program is very simple, the following example in bash is clear enough:
 ```bash
 ...
 which would return all parameters determining the following near optimal covering (this image is auto-generated by this program)
 <center>
